...
mod test {
    unittest "basic" {
        assert_eq(0.0f32, f32::parse("0").unwrap());
        assert_eq(-0.0f32, f32::parse("-0").unwrap());
        assert_eq(1.0f32, f32::parse("1").unwrap());
        assert_eq(-1.0f32, f32::parse("-1").unwrap());
        assert_eq(123456792.0f32, f32::parse("123456789").unwrap());
        assert_eq(299792448.0f32, f32::parse("299792458").unwrap());
    }

    unittest "min max" {
        assert_eq(1e-45f32, f32::parse("1e-45").unwrap());
    ...
    unittest "mantissa rounding overflow" {
        assert_eq(1.0f32, f32::parse("0.999999999").unwrap());
        assert_eq(f32::inf(), f32::parse("3.4028236e+38").unwrap());
        assert_eq(1.1754944e-38f32, f32::parse("1.17549430e-38").unwrap()); // FLT_MIN
        assert_eq(1.1754944e-38f32, f32::parse("1.17549431e-38").unwrap());
        assert_eq(1.1754944e-38f32, f32::parse("1.17549432e-38").unwrap());
        assert_eq(1.1754944e-38f32, f32::parse("1.17549433e-38").unwrap());
        assert_eq(1.1754944e-38f32, f32::parse("1.17549434e-38").unwrap());
        assert_eq(1.1754944e-38f32, f32::parse("1.17549435e-38").unwrap());
    }

    unittest "trailing zeros" {
        assert_eq(26843550.0f32, f32::parse("26843549.5").unwrap());
        assert_eq(50000004.0f32, f32::parse("50000002.5").unwrap());
        assert_eq(99999992.0f32, f32::parse("99999989.5").unwrap());
    }
}
