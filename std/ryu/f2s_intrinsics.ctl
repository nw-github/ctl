...
pub fn multiple_of_power_of_5_32(value: u32, p: u32): bool => pow5factor_32(value) >= p;
...
fn mul_shift_32(m: u32, factor: u64, shift: i32): u32 {
    ...
    let bits0 = m as u64 * u32::from(factor) as u64;
    let bits1 = m as u64 * u32::from(factor >> 32) as u64;

    let sum = (bits0 >> 32) + bits1;
    let shifted_sum = sum >> u32::from(shift - 32);
